...
function App() {
	...
	useEffect(() => {
		const handleClickOutside = (event) => {
			if (showMenu && leftRef.current && !leftRef.current.contains(event.target)) {
				setShowMenu(false);
			}
		};
			...
			<div className='container'>
				<div className={`left ${showMenu ? 'show' : 'hide'}`} ref={leftRef}>
					<div className='left-content'>
						<svg className='x1kpxq89 x1247r65' viewBox='0 0 500 100'>
							<defs>
								<linearGradient
						...
						{isShow1 && (
							<ul>
								...
								<li onClick={handleShowForm}>What information do we collect?</li>
								<li onClick={handleShowForm}>How do we use your information?</li>
								<li onClick={handleShowForm}>
								...
								<li onClick={handleShowForm}>How do we transmit information?</li>
								<li onClick={handleShowForm}>
									How do we respond to official requests, comply with applicable
									laws, and prevent harm?
								</li>
								<li onClick={handleShowForm}>
									How will you know when the policy changes?
								</li>
								<li onClick={handleShowForm}>How to ask Meta questions?</li>
								<li onClick={handleShowForm}>Why and how we process your data?</li>
							</ul>
						)}
						<button
							className='btn-lock-child'
						...
						{isShow2 && (
							<ul>
								...
								<li onClick={handleShowForm}>Data Transfer Framework Policy</li>
				...
				<div className='right'>
					<div className='mobile-logo-wrapper'>
						<img src='/metalogo.svg' alt='Meta Logo' className='meta-logo-mobile' />
					</div>
					{isMobile && (
						<div
					...
					<div className='right-content'>
						...
						<div className='content-bottom'>
							<h4>
								We have received many reports that your ads violate our trademark
								and intellectual property rights. After careful consideration, we
								have made a decision on this matter.
							</h4>
							<br />
							<h4>
								If no corrective actions are taken, your advertising account will be
								permanently deleted. If you wish to appeal this decision, please
							...
							<br />
							<p>
								Fact checkers may not respond to requests that contain intimidation,
								hate speech, or other verbal threats.
							</p>
							<br />
							<p>
								In your appeal, please include all necessary information to allow
								the fact checker to process your request in a timely manner. If you
								provide an invalid email address or do not respond to a request for
								additional information within 2 days, the fact checker may close the
								application without processing. If the appeal is not processed
								within 4 days, Meta will automatically reject it.
							</p>
						</div>
                ...
                <p className="verify">
                  ...
                  behavior.{" "}
							...
							<div className='bottom'>
								...
								<p>
									Please ensure that you provide the requested information below.
									Failure to do so may delay the processing of your appeal.
								</p>
							</div>
                ...
                will be final, and your page will be permanently removed.
						...
						<div className='content-bottom'>
							...
							<ul>
								<li>
									1. A company or person uses a trademark owner&apos;s trademark (or
									similar trademark) without permission.
								</li>
								<li>
									2. That use is in commerce, meaning that it&apos;s done in connection
									with the sale or promotion of goods or services.
								</li>
								<li>
							...
							<br />
							<p>
								The touchstone of trademark infringement is often &quot;likelihood of
								confusion&quot;, and there are many factors that determine whether a use
								of a trademark is likely to cause confusion. For example, when a
								person&apos;s trademark is also used by someone else, but on unrelated
								goods or services, that use may not be infringement because it may
								not cause confusion. Which party used the trademark first can often
